...
<body>
	...
	<div class="container-fluid">
		...
		<div class="button-row">
			<button>Find Old Students</button>
			<button>Age Wise Students Report</button>
		</div>
		<div class="button-row">
			<button>Contacts Report</button>
		...
		<div class="button-row">
			<button>Generate Student Biometric IDs</button>
			<button>Class Wise Student Roll</button>
		</div>
		<div class="button-row">
			<button>Student Name Slips</button>
		</div>
	</div>
	</div>
